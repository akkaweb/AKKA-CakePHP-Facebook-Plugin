THIS PLUGIN IS CURRENTLY FACING SOME ISSUES WHEN INSTALLED WITH COMPOSER. TESTING IS CURRENTLY UNDER WAY. PLEASE INSTALL MANUALLY AND FOLLOW INSTRUCTIONS TO ADD FACEBOOK SDK TO YOUR COMPOSER.
